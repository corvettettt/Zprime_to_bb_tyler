...
cd /afs/cern.ch/work/z/zhixing/private/CMSSW_10_3_3/src/Zprime_to_bb/run2/
...
mass=${masses[${mass_nr}]}
inputfile=../datacards/medium/bstar/combined/fully_combined_run2_M${mass}_MC.txt
tmp_stdout=MC_run2_${mass}.txt
outfile=../combine/limits/bstar/medium/combined_run2/fully_combined_run2_M${mass}_MC.txt

...
cd /afs/cern.ch/work/z/zhixing/private/CMSSW_10_3_3/src/Zprime_to_bb/2018/
...
mass=${masses[${mass_nr}]}
inputfile=../datacards/medium/bstar/combined/combined_2018_M${mass}_MC.txt
tmp_stdout=MC2018${mass}.txt
outfile=../combine/limits/bstar/medium/2018_M${mass}_MC.txt

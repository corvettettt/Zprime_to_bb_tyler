...
for i in "${masses[@]}"
  do
    ...
    cat 2016/MC2016${i}2.txt | grep -e Observed -e Expected | awk '{print $NF}' > combine/limits/bstar/medium/2016_M${i}_MC.txt
    cat 2016_data/data2016${i}.txt | grep -e Observed -e Expected | awk '{print $NF}' > combine/limits/bstar/medium/2016_M${i}.txt

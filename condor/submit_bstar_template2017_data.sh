...
cd /afs/cern.ch/work/z/zhixing/private/CMSSW_10_3_3/src/Zprime_to_bb/2017_data/
...
mass=${masses[${mass_nr}]}
inputfile=../datacards/medium/bstar/combined/combined_2017_M${mass}.txt
tmp_stdout=data2017${mass}.txt
outfile=../combine/limits/bstar/medium/2017_M${mass}.txt

...
cd /afs/cern.ch/work/z/zhixing/private/CMSSW_10_3_3/src/Zprime_to_bb/2016/
...
mass=${masses[${mass_nr}]}
inputfile=../datacards/medium/bstar/combined/combined_2016_M${mass}_MC.txt
tmp_stdout=MC2016${mass}.txt
outfile=../combine/limits/bstar/medium/2016_M${mass}_MC.txt

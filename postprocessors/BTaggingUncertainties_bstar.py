...
def BTagUncertainties(year, mass):
    ...
    file_path = NTUPLEDIR+"MC_bstar_{}_M{}.root".format(year,mass)
...
if __name__ == "__main__":
    uncertainties = {}
    with open('BTag_uncertainties_bstar.py', 'w') as fout:
        fout.write("###\n### automatically generated by postprocessors/BTaggingUncertainties.py and used by samples.py\n###\n\n")
        ...
        for m in mass_points:   
            ...
            fout.write("\t\t},\n")
        fout.write("\t}\n")
    print "Saved uncertainties as BTag_uncertainties_bstar.py"
